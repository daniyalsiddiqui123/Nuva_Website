...
const Privacy = () => {
  return (
    <div className="bg-black">
      <Navbar />
      <div className="bg-black">
        <h1 className="font-bold text-4xl text-amber-800 text-center">
          Privacy & Policies
        </h1>
        <div className="font-semibold mx-5 sm:mx-72 my-20 text-left text-white">
          ...
          defects.<br /> <br />{" "}
          <p className="text-xl font-bold text-center text-amber-800">
            How to start a return:
          </p>{" "}
          <br /> =&gt; Email us at nuvathrift@gmail.com with: <br /> •
          ...
          &ldquo;non-returnable&rdquo; on the product page. Late requests • Returns
